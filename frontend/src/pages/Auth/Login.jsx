...
/* Google keeps its official multi-color mark (standard practice for
   "Continue with Google" buttons) while the button surface itself stays
   neutral — only the icon carries color. GitHub stays a single-tone
   currentColor mark so it adapts naturally with the rest of the UI. */
function GoogleIcon() {
  return (
